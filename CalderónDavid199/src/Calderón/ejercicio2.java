...
public class ejercicio2 {
	...
	public static void main(String[] args) {
		...
		// Utilizo el dowhile porque si o si preguntare una vez el anyo
		do {
			...
			if (intentos != 3) {
				...
				if (anyo < 1801 || anyo > 2100) {
					...
					/*
					 * Uso este condicional para que cunado el usuario quiera acabar el programa no
					 * le salgo el mensaje de error
					 */
					...
					// En este if anidado comprueba de que siglo es el anyo introducido por el
					// usuario
					...
					/*
					 * En este otro if anidado compruebo si el anyo introducido es mayor, menor o
					 * igual que 2025
					 */
