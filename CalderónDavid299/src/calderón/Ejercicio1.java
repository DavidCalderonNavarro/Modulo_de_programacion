...
public class Ejercicio1 {
	...
	public static void main(String[] args) {
		...
		if (N < M) {
			...
			// Uso el bucle for para ir pasando por todos los numeros entre el incio y el
			// final
			for (int i = N; i <= M; i++) {
			...
			// Si el contador esta en 0 significa que ninguna de los numeros era multiplo de
			// 3 y 5
			if (contador == 0) {
